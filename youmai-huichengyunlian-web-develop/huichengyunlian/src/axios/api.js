...
export const httpGetUser = (url)=>fetch({
  url: url,
  method: 'get'
});

export const httpGet = (url)=>fetch({
  url: url,
  method: 'get'
});

export const httpGetParams = (url,params)=>fetch({
  url: url+"?userId="+localStorage.getItem("userId"),
  method: 'get',
  params: params
});

export const httpPost = (url,params)=>fetch({
  url: url+"?userId="+localStorage.getItem("userId"),
  method: 'post',
  data:params
});
export const httpDelete = (url,params)=>fetch({
  url: url+"?userId="+localStorage.getItem("userId"),
  method: 'delete',
  data:params
});
export const httpPut = (url,params)=>fetch({
  url: url+"?userId="+localStorage.getItem("userId"),
  method: 'put',
  data:params
});

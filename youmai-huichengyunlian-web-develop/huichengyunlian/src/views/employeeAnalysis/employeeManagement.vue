   ...
   <div class="authority-mgt">
      <div class="containerTitle">
        <el-row>
            ...
            <div class="right">
                <el-input v-model="username" size="small" prefix-icon="el-icon-search" placeholder="按员工名/手机搜索" class="block-search"></el-input>
            </div>
            <div class="right">
    ...
    <div class="containerBody">
        <el-table
            ...
            <el-table-column prop="userCode" label="员工CODE" ></el-table-column>
        ...
        <div>
            <el-form :model="userInline" :rules="rulesInline" ref="userInline" label-width="120px" class="demo-userInline">
                <el-form-item label="员工名" prop="username">
                    <el-input v-model="userInline.username" placeholder="请选择员工名称" @blur="mapName(userInline.username)"></el-input>
                </el-form-item>
                <el-form-item label="性别" prop="userSex">
                    <el-select v-model="userInline.userSex" placeholder="请选择员工性别">
                        <el-option
                ...
                <el-form-item label="状态" prop="userStatus">
                    <el-select v-model="userInline.userStatus" placeholder="请选择员工状态">
                        <el-option
      ...
      return{
        ...
        userInline:{//员工form
            ...
            userSex:'',
             password:'',//密码
            userMobile:'',
            tenantCode:'b78ded8f-209c-11e9-8101-52540016ed2f',//员工所属代理商code
            userEmail:'',
            validDate:'',
            userStatus:'',
        },
...
        },
        ...
        getTenantManageData(){
          let _this=this;
          _this.tenantData.push({"tenantName":"慧程天下","tenantId":"b78ded8f-209c-11e9-8101-52540016ed2f"})
      ...
      /*
        ...
        */
        getUserManageData(){
            ...
            httpGet("/auth/users?isEmployeeManager=true&tenantCode="+this.$store.state.tenantId+"&pageSize="+this.pageSize+"&currentPage="+this.currentPage)
             .then(function(response){

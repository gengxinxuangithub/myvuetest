<template>
  <div class="authority-mgt">
    <div class="containerTitle">
        <el-row >
            <div class="left">
                <el-button class="addBtn" style="cursor: pointer;" type="success" icon="el-icon-circle-plus-outline" @click="addNewClick" v-show="result.showAdd">新增</el-button>
        ...
        <el-table v-loading = "tableLoading" tooltip-effect="dark" @selection-change="handleSelectionChange" ref="multipleTable" stripe :data="tenantData" :height="tableHeight">
            ...
            <el-table-column label="操作" width="220px;">
                <template slot-scope="scope">
                    <el-button type="text" style="width:auto" @click="handleTenantEdit(scope.$index, scope.row)" :disabled="!result.showEdit">编辑</el-button>
                    ...
                    <el-button type="text" style="width:auto" @click="handleAgentStatus(scope.$index, scope.row)"  v-show="scope.row.isAgent==0" :disabled="!result.showEdit">升级俱乐部</el-button>
            ...
            <el-table-column width="300" prop="tenantName" label="俱乐部名称" > </el-table-column>
            
            <el-table-column label="俱乐部描述" :show-overflow-tooltip="true" prop="tenantDesc"></el-table-column>
            <el-table-column :show-overflow-tooltip="true" label="俱乐部管理员" width="120">
                <template slot-scope="scope">
                    <span>{{getNameByDict(scope.row.tenantAdminId) }}</span>
                </template>
            </el-table-column>
            <el-table-column :show-overflow-tooltip="true" label="是否俱乐部" width="100">
                <template slot-scope="scope">
            ...
            <el-table-column label="俱乐部期限" width="150" prop="validDate"></el-table-column>
            <el-table-column
    ...
    data(){
      return{
        ...
        tenantRules:{//俱乐部规则
            ...
            tenantDesc: [
                { required: true, message: '请填写俱乐部描述', trigger: 'blur' }
            ],           
        },
...
        },
      ...
      //查询所有俱乐部
        getTenantManageData(){
            ...
            httpGet("/auth/all_tenants?isAgentManager=false&pageSize="+this.pageSize+"&currentPage="+this.currentPage)
             .then(function(response){
